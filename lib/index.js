...
module.exports = {
    ...
    path: {
        IPFS: {
            privateKey: path.join(__dirname, '..', 'data', 'keys')
        }
    },
    ...
    ipfs: {
        ...
        config: {
            ...
            Bootstrap: [
                '/ip4/109.194.47.83/tcp/4004/ipfs/QmbdY5KnhG6Dk5fEJZQSVDhHN7sdhSzsKMnJU6MnpmRg5h', // tomsk verify
                '/ip4/192.168.88.211/tcp/4004/ipfs/QmbdY5KnhG6Dk5fEJZQSVDhHN7sdhSzsKMnJU6MnpmRg5h', // tomsk verify local
                '/ip4/109.194.47.83/tcp/4002/ipfs/QmQCH7nuh5osaTj2BDKThL54fBJiQ8d5YMPcTokEP3dRem', // tomsk node
